...
/*
 * Post skewer trimming and alignment for loss of Y calling
 * Tuned to map and id the indel
 */

// Declare Inputs
refFolder = file("/home/nwong/ls25_scratch/nick.wong/refFiles")
inputDirectory = file('fastq/trimmed')
AF_THR          = 0.0025

// Declare References 
refBase        = "${refFolder}/loy/hg19_chrX.fa.gz"
ref            = "${refBase}"
...
Channel.fromFilePairs("fastq/trimmed/*-trimmed-pair{1,2}.fastq.gz")
  .set{ ch_fastaIn }
...
process fastqc {
   ...
   publishDir path: 'qc_out/loy_fastqc', mode: 'copy'
...
process align_bwa {
   ...
   publishDir path: 'loy_out_bam2', mode: 'copy'
...
process bam_stats {
   ...
   publishDir path: 'qc_out/loy_samtools', mode: 'copy'
...
process bam_qc1 {
   ...
   publishDir path: 'qc_out/loy_picard', mode: 'copy'
...
process coverage_qc {
	...
	publishDir path: 'qc_out/loy_bedtools', mode: 'copy'
...
process vardict {
    ...
    publishDir path: 'loy_raw_variants', mode: 'copy'
...
process makeVCF {
    ...
    publishDir path: 'loy_vardict', mode: 'copy'
...
process sortVCFS {
    ...
    publishDir path: 'loy_variants_raw_out', mode: 'copy'                                    
