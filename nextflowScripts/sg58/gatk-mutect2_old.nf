...
// Declare Inputs
refFolder = file("/scratch/tn26/refFiles/hg38")
...
Channel.fromFilePairs("fastqs/*_R{1,2}.fastq.gz")
  .set{ ch_fastaIn }
...
process picardMarkDup {
   ...
   samtools index ${sampName}_sorted.mdups.bam
   """
}
...
process tumNorm {
    ...
    gatk Mutect2  \
     -R ${ref} \
     -I ${bam} \
     -I /home/nwong/rc78_scratch/angela.pizzola/2021-07-21-WES/IR1_1_7_HFJ25DSX2_AGAGTCAA_L002_sorted.mdups.bam \
     -normal IR1_1_7_HFJ25DSX2_AGAGTCAA_L002 \
     --germline-resource ${refFolder}/Homo_sapiens_assembly38.dbsnp138.vcf \
     -O ${sampName}.vcf.gz \
    """
}
