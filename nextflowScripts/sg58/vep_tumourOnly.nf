...
Channel.fromPath("tumourOnly/filtered/*.vcf.gz")
  .set{ ch_vardict }
  
process vep {
    label 'vep'
    containerOptions "-B ${refFolder}/vep_homo_sapiens:/opt/vep/.vep/homo_sapiens"
    ...
    publishDir path: './vep/tumourOnly', mode: 'copy'
